...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ffffff">Oracle Container Cloud Service + Wercker steeeeep</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by JOHN SMITH 233. Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
